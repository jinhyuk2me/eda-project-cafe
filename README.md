...
> 지도상에서는 두 브랜드 매장이 서울 전역에 고르게 분포해 있어 뚜렷한 특성을 식별하기 어려움
> 이에 따라 **물리적 거리 기반 분석(Haversine/KDTree)** 및 **도로명 주소 기반 상권 중복 분석**을 병행하여 두 브랜드의 실질적 공간 전략을 정량적으로 파악하고자 하였습니다.
